...
// define crystal object to come back to if time
var crystal = {
    ...
    imagesUrl: ["assets/images/pink.jpg", "assets/images/bluecrystal.jpg", "assets/images/greencrystalresized.jpg", "assets/images/pinkcrystal.jpg"]
};
...
function init() {
    ...
    for (var i = 0; i < 4; i++) {
        ...
        imageCrystal.attr("src", crystal.imagesUrl[i]);
